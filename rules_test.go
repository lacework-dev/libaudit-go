...
func (t *testRulesNetlinkConn) Receive(bytesize int, block int, rb []byte) ([]NetlinkMessage, error) {
...
func (t *testListRulesNetlinkConn) Receive(bytesize int, block int, rb []byte) ([]NetlinkMessage, error) {
	var v []NetlinkMessage
